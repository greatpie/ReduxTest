...
// 发起一系列 action
store.dispatch((0, _actions.addTodo)('pie1'));
store.dispatch((0, _actions.addTodo)('pie2'));
store.dispatch((0, _actions.addTodo)('pie3'));
store.dispatch((0, _actions.addTodo)('pie4'));
...
},{"./actions":22,"./reducers":24,"redux":17}],24:[function(require,module,exports){
'use strict';
